...
INSERT INTO "new_Inscripcion" ("apellido", "categoria", "club", "createdAt", "dni", "email", "fechaNacimiento", "id", "nombre", "telefono", "torneoId") SELECT "apellido", "categoria", "club", "createdAt", "dni", "email", "fechaNacimiento", "id", "nombre", "telefono", "torneoId" FROM "Inscripcion";
